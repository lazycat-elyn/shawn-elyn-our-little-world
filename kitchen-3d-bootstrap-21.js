const coreUrl='./kitchen-3d-modular-2.js?v=2500';
...
if(!source.includes(marker))throw new Error('Kitchen 2.5 bootstrap could not find render loop marker');
...
try{
  ...
  await import('./kitchen-3d-hifi-21.js?v=2500');
  await import('./kitchen-3d-hifi-22.js?v=2500');
  await import('./kitchen-3d-hifi-23.js?v=2500');
  await import('./kitchen-3d-hifi-24.js?v=2500');
  await import('./kitchen-3d-hifi-25.js?v=2500');
}finally{
