(()=>{
  ...
  function ensureFrame(){
    ...
    frame.title='Kitchen 3D Visual Rebuild 2.0';
    frame.src='./kitchen-3d-modular-2.html?embed=1&v=200';
    frame.allow='fullscreen';
    frame.addEventListener('load',()=>setTimeout(()=>sendState(frame.contentWindow),120));
    badge=document.createElement('div');
    badge.className='k3d-game-badge';
    badge.textContent='KITCHEN 3D VISUAL REBUILD 2.0 · 更接近参考图 · 🛍️ Shop · 📦 Inventory';
  ...
  window.KITCHEN_3D_GAME_INTEGRATION={version:'2.0',show:showKitchen3D,hide:hideKitchen3D,syncState:sendState};
})();
