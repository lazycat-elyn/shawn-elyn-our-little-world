const coreUrl='./kitchen-3d-modular-2.js?v=2100';
...
if(!source.includes(marker))throw new Error('Kitchen 2.1 bootstrap could not find render loop marker');
...
try{
  ...
  await import('./kitchen-3d-hifi-21.js?v=2100');
}finally{
