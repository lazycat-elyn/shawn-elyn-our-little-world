const coreUrl='./kitchen-3d-modular-2.js?v=2600';
...
if(!source.includes(marker))throw new Error('Kitchen 2.6 bootstrap could not find render loop marker');
...
try{
  ...
  await import('./kitchen-3d-hifi-21.js?v=2600');
  await import('./kitchen-3d-hifi-22.js?v=2600');
  await import('./kitchen-3d-hifi-23.js?v=2600');
  await import('./kitchen-3d-hifi-24.js?v=2600');
  await import('./kitchen-3d-hifi-25.js?v=2600');
  await import('./kitchen-3d-hifi-26.js?v=2600');
}finally{
